      ...
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16">
        ...
        >
          ...
          <div className="flex flex-col gap-8">
            <div className="flex items-center gap-6 text-gray-300 group cursor-pointer gpu">
            ...
            <div className="flex items-center gap-6 text-gray-300 group cursor-pointer gpu">
              ...
              <span className="text-xl group-hover:text-white transition-colors duration-300">Nairobi, Kenya</span>
            </div>
          </div>
        </motion.div>
        ...
        <motion.div 
          ...
          className="flex-1"
        >
          <form className="glass p-8 md:p-12 rounded-3xl flex flex-col gap-6 border border-white/5 shadow-2xl bg-black/40 gpu">
            ...
            <button type="button" className="mt-6 w-full py-5 rounded-xl bg-gradient-to-r from-[#00f0ff] to-[#7000ff] text-white font-bold text-lg hover:opacity-90 transition-all shadow-[0_0_20px_rgba(112,0,255,0.4)] gpu">
              Send Message
            </button>
          </form>
        </motion.div>
